...
function shortcode_panel_noway( $atts, $content = '' ) {
    return '<div class="tip mc-panel p-noway clearfix">' . $content . '</div>';
}
add_shortcode( 'noway' , 'shortcode_panel_noway' );

// 警告面板
function shortcode_panel_warning( $atts, $content = '' ) {
    return '<div class="tip mc-panel p-warning clearfix">' . $content . '</div>';
}
add_shortcode( 'warning' , 'shortcode_panel_warning' );

// 购买面板
function shortcode_panel_buy( $atts, $content = '' ) {
    return '<div class="tip mc-panel p-buy clearfix">' . $content . '</div>';
}
add_shortcode( 'buy' , 'shortcode_panel_buy' );

// 下载面板
function shortcode_panel_down( $atts, $content = '' ) {
    return '<div class="tip mc-panel p-down clearfix">' . $content . '</div>';
}
add_shortcode( 'down' , 'shortcode_panel_down' );

//打赏按钮
function shortcode_shang_button( $atts, $content= ''){
	return '<div class="mc-shang clearfix"><a href="javascript:document.getElementById(\'like-shang\').click();" class="mc-button mc-shang-button">'. $content .'</a></div>';
}
add_shortcode('pshang','shortcode_shang_button');
...
function shortcode_button_text( $atts, $content = '' ) {
    ...
    return '<a href="' .  $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-text"><span>' . $content . '</span></a>';
}
...
function shortcode_button_document( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-document"><span>' . $content . '</span></a>';
}
...
function shortcode_button_heart( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-heart"><span>' . $content . '</span></a>';
}
...
function shortcode_button_box( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-box"><span>' . $content . '</span></a>';
}
...
function shortcode_button_search( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-search"><span>' . $content . '</span></a>';
}
...
function shortcode_button_link( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-link"><span>' . $content . '</span></a>';
}
...
function shortcode_button_down( $atts, $content = '' ) {
    ...
    return '<a class="mc-button b-down" href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-down"><span>' . $content . '</span></a>';
}
...
function shortcode_button_next( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-next"><span>' . $content . '</span></a>';
}
...
function shortcode_button_audio( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-audio"><span>' . $content . '</span></a>';
}
...
function shortcode_button_video( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '?dl=1" target="' . $args['target'] . '" rel="nofollow" class="mc-button b-video"><span>' . $content . '</span></a>';
}
...
function shortcode_button_color( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" class="mc-button b-color" style="background: ' . $color . '" rel="nofollow"><span>' . $content . '</span></a>';
}
...
function shortcode_video( $atts, $content = '' ) {
 ...
 //   }
    ...
    return sprintf( '<video id="mc-video" class="mc-video" %s controls #iframeurl>%s</video>', join( ' ', $attr_strings ), $content );
}
...
function shortcode_swf( $atts, $content = '' ) {
    ...
    return sprintf( '<embed src="%s" type="application/x-shockwave-flash"/>', $content, join( ' ', $attr_strings ) );
}
...
function shortcode_link( $atts, $content = '' ) {
    ...
    return '<a href="' . $args['href'] . '" target="' . $args['target'] . '" title="' . $args['title'] . '" rel="nofollow" class="mc-link"><span>' . $content . '</span></a>';
}
